/**
 * SEO panel mappers — AIOSEO and SEOPress behind the shared minn_seo field.
 *
 ...
 * postmeta), REST-verifies SEOPress, and restores Yoast in finally.
 */
...
( async () => {
	...
	const IDS = { yoast: pluginId( 'yoast seo' ), aioseo: pluginId( 'all in one seo' ), seopress: pluginId( 'seopress' ) };
	t.check( 'All three SEO plugins installed', !! ( IDS.yoast && IDS.aioseo && IDS.seopress ), JSON.stringify( IDS ) );
