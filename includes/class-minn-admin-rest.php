...
class Minn_Admin_REST {
	...
	public static function render_blocks( WP_REST_Request $request ) {
		...
		// gallery previewed at the browser's default wrap (a real corporate
	...
	private static function catalog_external_info( $slug ) {
		$map = array(
			...
			'gravityforms' => array(
				...
				'description' => __( 'Build forms and manage their entries, notifications, feeds, and daily settings in Minn. Download the plugin .zip from your Gravity account.', 'minn-admin' ),
				'installs'    => 0,
				'version'     => '',
				'rating'      => 0,
				'icon'        => '',
				'source'      => 'upload',
				'homepage'    => 'https://www.gravityforms.com/pricing/',
			),
			'gravitysmtp' => array(
				'slug'        => 'gravitysmtp',
				'name'        => 'Gravity SMTP',
				'author'      => 'Gravity Forms',
				'description' => __( 'Send and track WordPress email through the full Email surface in Minn. Download the plugin .zip from a qualifying Gravity account.', 'minn-admin' ),
				'installs'    => 0,
				'version'     => '',
				'rating'      => 0,
				'icon'        => '',
				'source'      => 'upload',
				'homepage'    => 'https://www.gravityforms.com/gravity-smtp/',
			),
			'perfmatters' => array(
				'slug'        => 'perfmatters',
				'name'        => 'Perfmatters',
				'author'      => 'Perfmatters',
				'description' => __( 'Manage the Perfmatters settings estate from Minn\'s Performance surface. Download the paid plugin .zip from Perfmatters.', 'minn-admin' ),
				'installs'    => 0,
				'version'     => '',
				'rating'      => 0,
				'icon'        => '',
				'source'      => 'upload',
				'homepage'    => 'https://perfmatters.io/pricing/',
			),
			'advanced-custom-fields-pro' => array(
				'slug'        => 'advanced-custom-fields-pro',
				'name'        => 'ACF PRO',
				'author'      => 'WP Engine',
				'description' => __( 'Bring ACF PRO repeaters, flexible content, galleries, options pages, blocks, and field groups into Minn. Download the plugin .zip from ACF.', 'minn-admin' ),
				'installs'    => 0,
				'version'     => '',
				'rating'      => 0,
				'icon'        => '',
				'source'      => 'upload',
				'homepage'    => 'https://www.advancedcustomfields.com/pro/',
			),
			'elementor-pro' => array(
				'slug'        => 'elementor-pro',
				'name'        => 'Elementor Pro',
				'author'      => 'Elementor',
				'description' => __( 'Manage Elementor form submissions in Minn while keeping Elementor-owned page content protected. Download the plugin .zip from Elementor.', 'minn-admin' ),
				'installs'    => 0,
				'version'     => '',
				'rating'      => 0,
				'icon'        => '',
				'source'      => 'upload',
				'homepage'    => 'https://elementor.com/pro/',
			),
			'wpforms' => array(
				'slug'        => 'wpforms',
				'name'        => 'WPForms Pro',
				'author'      => 'WPForms',
				'description' => __( 'Manage WPForms Pro entries, read and starred state, spam, trash, search, and form filters in Minn. Download the plugin .zip from WPForms.', 'minn-admin' ),
				'installs'    => 0,
				'version'     => '',
				'rating'      => 0,
				'icon'        => '',
				'source'      => 'upload',
				'homepage'    => 'https://wpforms.com/pricing/',
			),
			'wp-rocket' => array(
				'slug'        => 'wp-rocket',
				'name'        => 'WP Rocket',
				'author'      => 'WP Media',
				'description' => __( 'Clear WP Rocket caches from Minn and monitor its license alongside other paid components. Download the plugin .zip from WP Rocket.', 'minn-admin' ),
				'installs'    => 0,
				'version'     => '',
				'rating'      => 0,
				'icon'        => '',
				'source'      => 'upload',
				'homepage'    => 'https://wp-rocket.me/pricing/',
			),
			'analyticswp' => array(
				'slug'        => 'analyticswp',
				'name'        => 'AnalyticsWP',
				'author'      => 'AnalyticsWP',
				'description' => __( 'Feed AnalyticsWP traffic and drill-down data into Minn\'s Overview. Download the paid plugin .zip from AnalyticsWP.', 'minn-admin' ),
				'installs'    => 0,
				'version'     => '',
				'rating'      => 0,
				'icon'        => '',
				'source'      => 'upload',
				'homepage'    => 'https://analyticswp.com/',
			),
