...
3. **Forms providers** — Ninja Forms ✅ shipped (v0.12.0 cycle: entries as
   ...
   Remaining: Formidable (`frm_items`). SureForms and MetForm likely fit
   too (free-tier storage believed but not source-verified).
