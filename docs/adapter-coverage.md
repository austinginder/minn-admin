...
| 6 | Enable Media Replace + core media polish | B | Wave D opener (unattached/date filters, "attached to", replace-in-place) | M | **EMR half shipped 2026-07-17** (⇅ Replace file, suite media-replace 12); core media polish (filters + attached-to) still open |
