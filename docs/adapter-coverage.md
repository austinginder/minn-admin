...
| 1 | forms status cards (fluent / ninja / forminator / flamingo) | A | Status-card parity with SureForms | S each | Carried from 07-27; optional polish, only if dogfooding wants inbox counts |
| 2 | WPForms Pro entries | B | Forms family | M–L | Still license-blocked; biggest uncovered forms name |
