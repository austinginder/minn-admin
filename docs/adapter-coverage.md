...
| scrutoscope | Diagnostics family (list + detail + status + Cron view + Profile this hook on 1.4+) | Y | 2026-07-27 | family `diagnostics`; capture UI = **L**; Profile fires real side effects under their profiler |
